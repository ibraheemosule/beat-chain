    ...
    <main className="container">
      <div className="hero">
        <div className="hero__title">
          <h1>
            Card with capabilities to  <br />play video
          </h1>
          <p>
          ...
          <span className="hero__title-link">Get Started
</span>
        ...
        <div className="hero__video-container">
          <video ref={videoTag} width="100%" height="300" muted="muted" poster={thumbnail} controls>
